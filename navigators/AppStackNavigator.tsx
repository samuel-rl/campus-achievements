...
import SettingsListDropdownView from "../screens/app/settingsScreens/SettingsListDropdownView";
...
const HomeStackScreen = ({ navigation }: any) => (
  <HomeStack.Navigator>
    ...
    />
    <HomeStack.Screen
      name="SettingsListDropdown"
      component={SettingsListDropdownView}
      options={{
        headerShown: false,
      }}
    />
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) => (
            <FontAwesome5
              name="home"
              color={focused ? colors.lightBlue : color}
              size={24}
            />
          ),
        }}

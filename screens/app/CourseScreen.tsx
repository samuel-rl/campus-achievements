...
import SettingsList from "./settingsScreens/SettingsListDropdownView";
  ...
  const renderHeader = () => {
    ...
    return (
      <View style={[styles.headerWrapper, { backgroundColor: course.color }]}>
        ...
        <TouchableOpacity
				//attention, le margin left ne doit pas convenir à tous les devices
          style={{ alignSelf: "center", marginLeft:300 }}
          onPress={() => {
						console.log("burger menu");
						//ouvrir un menu de paramètres
						navigation.navigate("SettingsListDropdown",{course});
          }}
        >
      ...
      <StickyParallaxHeader
        ...
        tabs={[
          ...
          },
          {
            title: "Compétences",
            content: (
              <ListSkills skills={course.skills} navigation={navigation} />
            ),
          },
          {
            title: "Discussion",
          ...
          // {
          //   title: "Paramètres",
          //   // content: <SettingsList user={Fire.shared.user()} />,
